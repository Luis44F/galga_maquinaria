...
<head>
    ...
    <title>GALGA · Nuevo Proveedor</title>
...
<body>
    <div class="container">
        <div class="header">
            <h1><i class="fas fa-plus-circle"></i> Nuevo Proveedor</h1>
            ...
            <form action="{{ route('proveedores.store') }}" method="POST">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" name="codigo" class="form-control" value="{{ old('codigo') }}" placeholder="Ej: PROV-001" required>
                    </div>
                    <div class="form-group">
                        <label class="form-label">NIT</label>
                        <input type="text" name="nit" class="form-control" value="{{ old('nit') }}" placeholder="Ej: 900123456-7">
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" name="pais" class="form-control" value="{{ old('pais') }}" placeholder="Ej: China, EE.UU., Colombia">
                    </div>
                    <div class="form-group">
                        <label class="form-label">Ciudad</label>
                        <input type="text" name="ciudad" class="form-control" value="{{ old('ciudad') }}" placeholder="Ej: Shanghai, Bogotá">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="email" name="contacto_email" class="form-control" value="{{ old('contacto_email') }}">
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="observaciones" class="form-control" placeholder="Información adicional...">{{ old('observaciones') }}</textarea>
                </div>
